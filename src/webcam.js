...
class Webcam {
  ...
  getMediaConstraints() {
    ...
    videoConstraints.height = window.innerHeight;
  ...
  async snap() {
    //set width and height to myCanvas
    ...
    if (this._canvasElement != null) {
      ...
      //clear width and height of #canvas and place video
      context.clearRect(
        0,
        0,
      ...
      const blob = await this.getImage("c");
      ...
      //get 3d object and place it #c canvas
      ...
      //add 3d object and video to #myCanvas
      ...
      return final; //return final image
    } else {
